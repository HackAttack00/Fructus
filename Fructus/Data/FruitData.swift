...
//  Fructus
//
//  Created by Seungchul Lee on 2023/02/28.
//
...
let fruitsData: [Fruit] = [
    Fruit(
        ...
        description: """
          Blueberries are perennial flowering plants with blue or purple berries. They are classified in the section Cyanococcus within the genus Vacciniåum. Vaccinium also includes cranberries, bilberries, huckleberries and Madeira blueberries.
